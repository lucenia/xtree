...
protected:
    ...
    void SetUp() override {
        ...
        idx = new IndexDetails<DataRecord>(2, 32, dimLabels, nullptr, nullptr);
        ...
        // Use TRADITIONAL backend for tests to avoid MMAP hanging issues on Windows
        cow_manager = new DirectMemoryCOWManager<DataRecord>(idx, snapshot_file, 
            DirectMemoryCOWManager<DataRecord>::BackendType::TRADITIONAL);
